...
find 2 md5 strings that collision
can be with non-alphabetic characters

https://x.com/realhashbreaker/status/1770161965006008570
"""

m1 = "TEXTCOLLBYfGiJUETHQ4hAcKSMd5zYpgqf1YRDhkmxHkhPWptrkoyz28wnI9V0aHeAuaKnak".encode()
m2 = "TEXTCOLLBYfGiJUETHQ4hEcKSMd5zYpgqf1YRDhkmxHkhPWptrkoyz28wnI9V0aHeAuaKnak".encode()
...
print("wow")
print(json.dumps({"document":m1.hex()}))
print(json.dumps({"document":m2.hex()}))