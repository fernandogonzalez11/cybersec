...
def check(password):
    ...
    print(f"{type(array.prod())}")
    # normally the product of numbers wouldnt be prime so it prob has to do with that
    # make a special product that passes isPrime? prob: 1e-6
    # overflow? prod is numpy.int64
